            ...
            <main class="px-4">
                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-12">
                        <form action="{{ route('stok.store') }}" class="needs-validation" enctype="multipart/form-data" method="POST" novalidate>
                            @csrf
                            <div class="row g-3">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" class="money form-control" name="harga" placeholder="" required>
                                    </div>
                                </div>

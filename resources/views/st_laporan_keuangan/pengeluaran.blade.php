...
@section('container')
            <main class="p-4">
                ...
                <div class="row" id="pemasukan">
                    <h1 align="center" class="h3" id="title-musi">Laporan Pengeluaran</h1>
                    <div class="col-md-6">
                        <div class="table-responsive mt-4 mb-4">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th id="total_pemasukan_kotor" width="30%" scope="col">Rp. 0</th>
                                </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="nama_pembeli" class="col-form-label">Nama Toko</label>
                                <p id="nama_toko" class="fs-5">-</p>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="17.5%" scope="col">Unit</th>
                                            <th width="7.5%" scope="col">Total Harga</th>
                                        </tr>
                                    </thead>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            async function getTransaksiLaporan(month, year, type) {
                ...
                var url = `{{ route('transaksi_laporan_keuangan') }}?month=${encodeURIComponent(param.month)}&year=${encodeURIComponent(param.year)}`
            ...
            async function getLaporanKeuangan(month, year) {
                const param = {
                    month: month,
                    year: year
                }

                var url = `{{ route('laporan_keuangan') }}?month=${encodeURIComponent(param.month)}&year=${encodeURIComponent(param.year)}`
            ...
            async function setLaporanKeuangan(month, year) {
                var laporan = await getLaporanKeuangan(month, year)
